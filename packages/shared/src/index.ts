...
export interface SignalDto {
  ...
  orderUsd: number;
  /**
   * Доля при orderUsd === 0 (от **equity** USDT на счёте — `totalUsd` с биржи; при отсутствии — от доступного).
   * 1–100: доля **маржи** (% от equity); номинал позиции = маржа × leverage.
   * При значении > 100: **номинал** = equity × (pct/100); плечо в эту формулу не входит (задаётся на бирже к позиции).
   */
