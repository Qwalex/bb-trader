...
import {
  ...
  SAMPLE_HINTS,
  SECTION_TITLE_STYLE,
} from './filters-page.constants';
import type { FilterItem, FilterKind, PatternItem } from './filters-page.types';
import { filtersApiFetch } from './filters-page.util';
...
export default function FiltersPage() {
  ...
  const apiFetch = filtersApiFetch;
